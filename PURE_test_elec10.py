...
dropdown1List[3].click()                                        # Change List element according to the election

time.sleep(2)

types2 = driver.find_elements(By.CLASS_NAME, 'ng-arrow-wrapper')
types2[1].click()                                       # Click on the dropdown list for the type of result
time.sleep(2)

dropdown2List = driver.find_elements(By.CLASS_NAME, 'ng-option')
dropdown2List[3].click()                            # Change List element according to the election. Choose "Seçim Türü"
...
dropdowns[3].click()                        # Cities listed
time.sleep(1)
...
for index in range(len(cityList)):             # :: CHANGE HERE ::
    cityList = driver.find_elements(By.CLASS_NAME, 'ng-option')
